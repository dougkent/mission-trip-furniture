        ...
        return (
            <div className={classes.aboutContainer}>
                        ...
                        <Typography variant='body1' component='div'>
                            <ul className={classes.list}>
                                ...
                                <li>
                                    ...
                                    a job (i.e., women and children). This is a
                                    way that more affluent missionaries are able
                                    to build up the communities they are
                                    supporting.
                                </li>
                                <li>
                ...
                <Typography variant='caption' paragraph>
                    ...
                    not here to supplement those explanations; however, it is
